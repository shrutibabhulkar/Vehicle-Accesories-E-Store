...
class SafetyAccessories extends Component {
  constructor(props) {
    super(props);
    this.state = {
      products: [],
  ...
  componentDidMount() {
    ApiService.fetchProductSafetyAccessories().then((resp) => {
...
export default SafetyAccessories;

// this.state.products.map((p1) => (
// <div className="container-xl" key={p1.id}>
//   <div className="card mr-3 " style={{ width: "12rem" }}>
//     <img className="card-img-top" src={p1.imgUrl} alt="Card image cap" />
//     <div className="card-body">
//       <h5 className="card-title">{p1.name}</h5>
//       <p className="card-text"> Price: Rs.{p1.price}/-</p>
//       <div className="row">
