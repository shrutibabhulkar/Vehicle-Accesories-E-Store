...
class ApiService {
  ...
  fetchProductBodyParts() {
    return axios.get(USER_API_BASE_URL + "/products/category/BodyParts");
  }

  fetchProductSafetyAccessories() {
    return axios.get(
      USER_API_BASE_URL + "/products/category/SafetyAccessories"
    );
  }

  fetchProductBatteries() {
    return axios.get(USER_API_BASE_URL + "/products/category/Batteries");
  }
